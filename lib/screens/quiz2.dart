...
final questions = [
  Question(text: 'Сколько типов данных в Python ', options: [
    Option(isCorrect: true, text: '3'),
    Option(isCorrect: false, text: '1'),
    Option(isCorrect: false, text: '2'),
    Option(isCorrect: false, text: '5'),
  ]),
  Question(text: 'Строки это тип - ', options: [
    Option(isCorrect: true, text: 'str'),
    Option(isCorrect: false, text: 'String'),
    Option(isCorrect: false, text: 'string'),
    Option(isCorrect: false, text: 'Str'),
  ]),
  Question(
      text: '\'Hello\' + \'World\' ',
      options: [
        Option(isCorrect: false, text: 'Hello world'),
        Option(isCorrect: false, text: '"Helloworld"'),
        Option(isCorrect: false, text: 'World Hello'),
        Option(isCorrect: true, text: 'WorldHello'),
      ]),
  Question(text: '1+ \'a\' ', options: [
    Option(isCorrect: false, text: '1a'),
    Option(isCorrect: true, text: 'error'),
    Option(isCorrect: false, text: '1 a'),
  ]),
];
